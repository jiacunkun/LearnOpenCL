...
MInt32 Img_Guass3x3_Down2_C1_Range(MHandle hMemMgr, MByte* pSrcImg, MInt32 lSrcWidth, MInt32 lSrcHeight, MInt32 lSrcPitch,
...
MInt32 Img_Guass3x3_Down2_C2_Range(MHandle hMemMgr, MByte* pSrcImg, MInt32 lSrcWidth, MInt32 lSrcHeight, MInt32 lSrcPitch,
...
MVoid thread_Img_GuassDownScale_C1(MVoid* pParam)
{
...
MVoid thread_Img_GuassDownScale_C2(MVoid* pParam)
{
	LpImg_Down_Scale_St Img_Down2_sturct = (LpImg_Down_Scale_St)pParam;
	MHandle hMemMgr = Img_Down2_sturct->hMemMgr;
	MByte* pSrcImg = Img_Down2_sturct->pSrcImg;
