...
// yz
CLOG_DEFINE_LOG_DEBUG(log_d, NULL, CLOG_DEBUG);
CLOG_DEFINE_LOG_INFO(log_i, NULL, CLOG_INFO);
CLOG_DEFINE_LOG_WARNING(log_w, NULL, CLOG_WARNING);
CLOG_DEFINE_LOG_ERROR(log_e, NULL, CLOG_ERROR);
CLOG_DEFINE_LOG_FATAL(log_f, NULL, CLOG_FATAL);
