...
@todo:
*******************************************************************************/
#ifndef _H_NLMEANS16_H_
#define _H_NLMEANS16_H_
...
NS_SINFLE_IMAGE_ENHANCEMENT_BEGIN
    ...
    {
    public:
        NLMeans16(MHandle hMemMgr, MHandle mcvParallelMonitor = MNull, MFloat fIntensity = 70.0);
        ...
        /// @return
        MInt32 Run(ImageInfo<MInt16> *pSrcImg,
                   ImageInfo<MInt16> *pDstImg,
                   ImageInfo<MByte> *pDnShade = MNull,
                   MFloat fIntensity = -1,
    ...
    private:
        ...
        **********************************************************/
        ...
        /// @param l_add        [in]
        /// @return
        MVoid ProcessPointBround(MInt16 *pCurPoint,
                                 MInt16 *pPrePoint,
                                 MInt16 *pNexPoint,
                                 MInt16 *pDstPoint,
                                 MInt32 *pMap,
        ...
        **********************************************************/
        ...
        /// @param pInvMap
        /// @return
        MVoid ProcessPoint(MInt16 *pCurPoint,
                           MInt16 *pPrePoint,
                           MInt16 *pNexPoint,
                           MInt16 *pDstPoint,
                           MInt32 *pMap,
        ...
        **********************************************************/
        ...
        /// @param lPitch       [in]
        /// @return 匹配距离和
        MInt32 GetBlockDiff(MInt16 *pCurBlock, MInt16 *pNeiBlock, MInt32 lPitch);
        ...
        /// @param lW           [in]
        /// @return
        MVoid AddBlockSum(MInt16 *pNeiBlock, MInt32 lPitch, MInt32 *lSumWei, MInt32 lW);
        ...
        /// @param pMap         [in]
        /// @return
        MVoid AddBlockSumByNei(MInt16 *pCurBlock,
                               MInt16 *pNeiBlock,
                               MInt32 lPitch,
                               MInt32 *lSumWei,
                               MInt32 *pMap,
        ...
        /// @param pInvMap      [in]
        /// @return
        MVoid GetBlockResult(MInt16 *pDstBlock,
                             MInt32 lPitch,
                             MInt32 *lSumWei,
                             MInt32 *pInvMap);
        ...
        /// @param pInvMap
        /// @return
        MVoid ProcessBlock4x4(MInt16 *pCurLine,
                              MInt16 *pPreLine,
                              MInt16 *pNexLine,
                              MInt16 *pDstLine,
                              MInt32 *pMap,
        ...
        **********************************************************/
        ...
        /// @param plW
        /// @param pSharedBuffer
        void GetBlockDiff4Neon(MInt16 *pCurLine,
                               MInt16 *pPreLine,
                               MInt16 *pNexLine,
                               MInt32 lPitch,
                               MInt32 *pMap,
        ...
        /// @param plW
        /// @param pSharedBuffer
        void GetBlockDiff8Neon(MInt16 *pCurLine,
                               MInt16 *pPreLine,
                               MInt16 *pNexLine,
                               MInt32 lPitch,
                               MInt32 *pMap,
        ...
        /// @param lSumWei
        /// @param plW
        void AddBlockSumByNei3x3Neon(MInt16 *pCurLine,
                                     MInt16 *pPreLine,
                                     MInt16 *pNexLine,
                                     MInt32 lPitch,
                                     MInt32 *lSumWei,
        ...
        /// @param pDstLine
        /// @param pInvMap
        void ProcessBlock4x4Neon(MInt16 *pCurLine,
                                 MInt16 *pPreLine,
                                 MInt16 *pNexLine,
                                 MInt32 *lSumWei,
                                 MInt32 lPitch,
        ...
        **********************************************************/
        ...
        /// @param pInvMap
        /// @return
        MVoid ProcessLinesBroundMain(MInt16 *pCurLine,
                                     MInt16 *pPreLine,
                                     MInt16 *pDstLine,
                                     MInt32 lWidth,
                                     MInt32 *pMap,
        ...
        /// @param pInvMap
        /// @return
        MVoid ProcessLines1Main(MInt16 *pCurLine,
                                MInt16 *pPreLine,
                                MInt16 *pNexLine,
                                MInt16 *pDstLine,
                                MInt32 lWidth,
        ...
        /// @param pInvMap
        /// @return
        MVoid ProcessLines4Main(MInt16 *pCurLine,
                                MInt16 *pPreLine,
                                MInt16 *pNexLine,
                                MInt16 *pDstLine,
                                MInt32 lWidth,
        ...
        /// @return
        MInt32 Process(ImageInfo<MInt16> *pSrcImg,
                       ImageInfo<MInt16> *pDstImg,
