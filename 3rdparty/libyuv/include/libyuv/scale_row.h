...
//Shielding mmi platform from google in 2018-07-27
...
void ScaleRowDown2_16_C(const uint16_t* src_ptr,
                        ...
                        uint16_t* dst,
                        int dst_width);
void ScaleInterveinRowDown2_C(const uint8_t* src_ptr,
                              ptrdiff_t src_stride,
                              uint8_t* dst,
                              int dst_width);
...
void ScaleRowDown2Linear_16_C(const uint16_t* src_ptr,
                              ...
                              uint16_t* dst,
                              int dst_width);
void ScaleInterveinRowDown2Linear_C(const uint8_t* src_ptr,
                                    ptrdiff_t src_stride,
                                    uint8_t* dst,
                                    int dst_width);
...
void ScaleRowDown2Box_16_C(const uint16_t* src_ptr,
                           ...
                           uint16_t* dst,
                           int dst_width);
void ScaleInterveinRowDown2Box_C(const uint8_t* src_ptr,
                                 ptrdiff_t src_stride,
                                 uint8_t* dst,
                                 int dst_width);
...
void ScaleRowDown4_16_C(const uint16_t* src_ptr,
                        ...
                        uint16_t* dst,
                        int dst_width);
void ScaleInterveinRowDown4_C(const uint8_t* src_ptr,
                              ptrdiff_t src_stride,
                              uint8_t* dst,
                              int dst_width);
...
void ScaleRowDown4Box_16_C(const uint16_t* src_ptr,
                           ...
                           uint16_t* dst,
                           int dst_width);
void ScaleInterveinRowDown4Box_C(const uint8_t* src_ptr,
                                 ptrdiff_t src_stride,
                                 uint8_t* dst,
                                 int dst_width);
...
void ScaleRowDown34_16_C(const uint16_t* src_ptr,
                         ...
                         uint16_t* dst,
                         int dst_width);
void ScaleInterveinRowDown34_C(const uint8_t* src_ptr,
                               ptrdiff_t src_stride,
                               uint8_t* dst,
                               int dst_width);
...
void ScaleRowDown34_0_Box_16_C(const uint16_t* src_ptr,
                               ...
                               uint16_t* d,
                               int dst_width);
void ScaleInterveinRowDown34_0_Box_C(const uint8_t* src_ptr,
                                     ptrdiff_t src_stride,
                                     uint8_t* d,
                                     int dst_width);
...
void ScaleRowDown34_1_Box_16_C(const uint16_t* src_ptr,
                               ...
                               uint16_t* d,
                               int dst_width);
void ScaleInterveinRowDown34_1_Box_C(const uint8_t* src_ptr,
                                     ptrdiff_t src_stride,
                                     uint8_t* d,
                                     int dst_width);
...
void ScaleCols_16_C(uint16_t* dst_ptr,
                    ...
                    int x,
                    int dx);
void ScaleInterveinCols_C(uint8_t* dst_ptr,
                              const uint8_t* src_ptr,
                              int dst_width,
                              int x,
                              int dx);
...
void ScaleColsUp2_16_C(uint16_t* dst_ptr,
                       ...
                       int,
                       int);
void ScaleInterveinColsUp2_C(uint8_t* dst_ptr,
                             const uint8_t* src_ptr,
                             int dst_width,
                             int x,
                             int dx);
...
void ScaleFilterCols64_C(uint8_t* dst_ptr,
                         ...
                         int x32,
                         int dx);
void ScaleFilterInterveinCols_C(uint8_t* dst_ptr,
                                const uint8_t* src_ptr,
                                int dst_width,
                                int x,
                                int dx);
...
void ScaleRowDown38_16_C(const uint16_t* src_ptr,
                         ...
                         uint16_t* dst,
                         int dst_width);
void ScaleInterveinRowDown38_C(const uint8_t* src_ptr,
                               ptrdiff_t src_stride,
                               uint8_t* dst,
                               int dst_width);
...
void ScaleRowDown38_3_Box_16_C(const uint16_t* src_ptr,
                               ...
                               uint16_t* dst_ptr,
                               int dst_width);
void ScaleInterveinRowDown38_3_Box_C(const uint8_t* src_ptr,
                                     ptrdiff_t src_stride,
                                     uint8_t* dst_ptr,
                                     int dst_width);
...
void ScaleRowDown38_2_Box_16_C(const uint16_t* src_ptr,
                               ...
                               uint16_t* dst_ptr,
                               int dst_width);
void ScaleInterveinRowDown38_2_Box_C(const uint8_t* src_ptr,
                                     ptrdiff_t src_stride,
                                     uint8_t* dst_ptr,
                                     int dst_width);
...
void ScaleARGBRowDown2Box_C(const uint8_t* src_argb,
                            ...
                            uint8_t* dst_argb,
                            int dst_width);
void ScaleARGBRowDown3_C(const uint8_t* src_argb,
                         ptrdiff_t src_stride,
                         uint8_t* dst_argb,
                         int dst_width);
void ScaleARGBRowDown3Linear_C(const uint8_t* src_argb,
                               ptrdiff_t src_stride,
                               uint8_t* dst_argb,
                               int dst_width);
void ScaleARGBRowDown3BiLinear_C(const uint8_t* src_argb,
                                 ptrdiff_t src_stride,
                                 uint8_t* dst_argb,
                                 int dst_width);
void ScaleARGBRowDown3Box_C(const uint8_t* src_argb,
                            ptrdiff_t src_stride,
                            uint8_t* dst_argb,
                            int dst_width);
...
// modify by 王钦 on 2018-12-11
// ScaleARGBFilterCols中会存在<=2的误差
// MTlabScaleARGBFilterCols中修复ScaleARGBFilterCols的误差问题。

void MTlabScaleARGBFilterCols_C(uint8_t* dst_argb,
                                const uint8_t* src_argb,
                                int dst_width,
                                int x,
                                int dx);
void MTlabScaleARGBFilterCols64_C(uint8_t* dst_argb,
                                  const uint8_t* src_argb,
                                  int dst_width,
                                  int x32,
                                  int dx);
...
void MTlabScaleARGBFilterCols_SSSE3(uint8_t* dst_argb,
                               const uint8_t* src_argb,
                               int dst_width,
                               int x,
                               int dx);
void MTlabScaleARGBFilterCols_NEON(uint8_t* dst_argb,
                              const uint8_t* src_argb,
                              int dst_width,
                              int x,
                              int dx);
void MTlabScaleARGBFilterCols_Any_NEON(uint8_t* dst_ptr,
                                  const uint8_t* src_ptr,
                                  int dst_width,
                                  int x,
                                  int dx);
...
void ScaleARGBRowDown2_NEON(const uint8_t* src_ptr,
                            ...
                            uint8_t* dst,
                            int dst_width);
void ScaleARGBRowDown3_NEON(const uint8_t* src_ptr,
                            ptrdiff_t src_stride,
                            uint8_t* dst,
                            int dst_width);
void ScaleARGBRowDown2Linear_NEON(const uint8_t* src_argb,
                                  ...
                                  uint8_t* dst_argb,
                                  int dst_width);
void ScaleARGBRowDown3Linear_NEON(const uint8_t* src_argb,
                                  ptrdiff_t src_stride,
                                  uint8_t* dst_argb,
                                  int dst_width);
void ScaleARGBRowDown3BiLinear_NEON(const uint8_t* src_argb,
                                  ptrdiff_t src_stride,
                                  uint8_t* dst_argb,
                                  int dst_width);
void ScaleARGBRowDown2Box_NEON(const uint8_t* src_ptr,
                               ...
                               uint8_t* dst,
                               int dst_width);
void ScaleARGBRowDown3Box_NEON(const uint8_t* src_ptr,
                               ptrdiff_t src_stride,
                               uint8_t* dst,
                               int dst_width);
...
void ScaleARGBRowDown2_Any_NEON(const uint8_t* src_ptr,
                                ...
                                uint8_t* dst_ptr,
                                int dst_width);
void ScaleARGBRowDown3_Any_NEON(const uint8_t* src_ptr,
                                ptrdiff_t src_stride,
                                uint8_t* dst,
                                int dst_width);
void ScaleARGBRowDown2Linear_Any_NEON(const uint8_t* src_ptr,
                                      ...
                                      uint8_t* dst_ptr,
                                      int dst_width);
void ScaleARGBRowDown3Linear_Any_NEON(const uint8_t* src_argb,
                                      ptrdiff_t src_stride,
                                      uint8_t* dst_argb,
                                      int dst_width);
void ScaleARGBRowDown3BiLinear_Any_NEON(const uint8_t* src_argb,
                                        ptrdiff_t src_stride,
                                        uint8_t* dst_argb,
                                        int dst_width);
void ScaleARGBRowDown2Box_Any_NEON(const uint8_t* src_ptr,
                                   ...
                                   uint8_t* dst_ptr,
                                   int dst_width);
void ScaleARGBRowDown3Box_Any_NEON(const uint8_t* src_ptr,
                                   ptrdiff_t src_stride,
                                   uint8_t* dst,
                                   int dst_width);
...
void ScaleRowDown2_NEON(const uint8_t* src_ptr,
                        ...
                        uint8_t* dst,
                        int dst_width);
void ScaleInterveinRowDown2_NEON(const uint8_t* src_ptr,
                                 ptrdiff_t src_stride,
                                 uint8_t* dst,
                                 int dst_width);
void ScaleRowDown2Linear_NEON(const uint8_t* src_ptr,
                              ...
                              uint8_t* dst,
                              int dst_width);
void ScaleInterveinRowDown2Linear_NEON(const uint8_t* src_ptr,
                                       ptrdiff_t src_stride,
                                       uint8_t* dst,
                                       int dst_width);
void ScaleRowDown2Box_NEON(const uint8_t* src_ptr,
                           ...
                           uint8_t* dst,
                           int dst_width);
void ScaleInterveinRowDown2Box_NEON(const uint8_t* src_ptr,
                                    ptrdiff_t src_stride,
                                    uint8_t* dst,
                                    int dst_width);
...
void ScaleRowDown4_NEON(const uint8_t* src_ptr,
                        ...
                        uint8_t* dst_ptr,
                        int dst_width);
void ScaleInterveinRowDown4_NEON(const uint8_t* src_ptr,
                                 ptrdiff_t src_stride,
                                 uint8_t* dst_ptr,
                                 int dst_width);
void ScaleRowDown4Box_NEON(const uint8_t* src_ptr,
                           ...
                           uint8_t* dst_ptr,
                           int dst_width);
void ScaleInterveinRowDown4Box_NEON(const uint8_t* src_ptr,
                                    ptrdiff_t src_stride,
                                    uint8_t* dst_ptr,
                                    int dst_width);
...
void ScaleRowDown34_NEON(const uint8_t* src_ptr,
                         ...
                         uint8_t* dst_ptr,
                         int dst_width);
void ScaleInterveinRowDown34_NEON(const uint8_t* src_ptr,
                              ptrdiff_t src_stride,
                              uint8_t* dst_ptr,
                              int dst_width);
void ScaleRowDown34_0_Box_NEON(const uint8_t* src_ptr,
                               ...
                               uint8_t* dst_ptr,
                               int dst_width);
void ScaleInterveinRowDown34_0_Box_NEON(const uint8_t* src_ptr,
                                    ptrdiff_t src_stride,
                                    uint8_t* dst_ptr,
                                    int dst_width);
void ScaleRowDown34_1_Box_NEON(const uint8_t* src_ptr,
                               ...
                               uint8_t* dst_ptr,
                               int dst_width);
void ScaleInterveinRowDown34_1_Box_NEON(const uint8_t* src_ptr,
                                        ptrdiff_t src_stride,
                                        uint8_t* dst_ptr,
                                        int dst_width);
...
void ScaleRowDown38_NEON(const uint8_t* src_ptr,
                         ...
                         uint8_t* dst_ptr,
                         int dst_width);
void ScaleInterveinRowDown38_NEON(const uint8_t* src_ptr,
                                  ptrdiff_t src_stride,
                                  uint8_t* dst_ptr,
                                  int dst_width);
// 32x3 -> 12x1
void ScaleRowDown38_3_Box_NEON(const uint8_t* src_ptr,
                               ...
                               uint8_t* dst_ptr,
                               int dst_width);
void ScaleInterveinRowDown38_3_Box_NEON(const uint8_t* src_ptr,
                                       ptrdiff_t src_stride,
                                       uint8_t* dst_ptr,
                                        int dst_width);
// 32x2 -> 12x1
void ScaleRowDown38_2_Box_NEON(const uint8_t* src_ptr,
                               ...
                               uint8_t* dst_ptr,
                               int dst_width);
void ScaleInterveinRowDown38_2_Box_NEON(const uint8_t* src_ptr,
                                        ptrdiff_t src_stride,
                                        uint8_t* dst_ptr,
                                        int dst_width);
...
void ScaleRowDown2Box_Odd_NEON(const uint8_t* src_ptr,
                               ...
                               uint8_t* dst_ptr,
                               int dst_width);
void ScaleInterveinRowDown2_Any_NEON(const uint8_t* src_ptr,
                            ptrdiff_t src_stride,
                            uint8_t* dst,
                            int dst_width);
void ScaleInterveinRowDown2Linear_Any_NEON(const uint8_t* src_ptr,
                                  ptrdiff_t src_stride,
                                  uint8_t* dst,
                                  int dst_width);
void ScaleInterveinRowDown2Box_Any_NEON(const uint8_t* src_ptr,
                               ptrdiff_t src_stride,
                               uint8_t* dst,
                               int dst_width);
...
void ScaleRowDown4Box_Any_NEON(const uint8_t* src_ptr,
                               ...
                               uint8_t* dst_ptr,
                               int dst_width);
void ScaleInterveinRowDown4_Any_NEON(const uint8_t* src_ptr,
                            ptrdiff_t src_stride,
                            uint8_t* dst_ptr,
                            int dst_width);
void ScaleInterveinRowDown4Box_Any_NEON(const uint8_t* src_ptr,
                               ptrdiff_t src_stride,
                               uint8_t* dst_ptr,
                               int dst_width);
...
void ScaleRowDown34_1_Box_Any_NEON(const uint8_t* src_ptr,
                                   ...
                                   uint8_t* dst_ptr,
                                   int dst_width);
void ScaleInterveinRowDown34_Any_NEON(const uint8_t* src_ptr,
                             ptrdiff_t src_stride,
                             uint8_t* dst_ptr,
                             int dst_width);
void ScaleInterveinRowDown34_0_Box_Any_NEON(const uint8_t* src_ptr,
                                   ptrdiff_t src_stride,
                                   uint8_t* dst_ptr,
                                   int dst_width);
void ScaleInterveinRowDown34_1_Box_Any_NEON(const uint8_t* src_ptr,
                                   ptrdiff_t src_stride,
                                   uint8_t* dst_ptr,
                                   int dst_width);
// 32 -> 12
...
void ScaleRowDown38_2_Box_Any_NEON(const uint8_t* src_ptr,
                                   ...
                                   uint8_t* dst_ptr,
                                   int dst_width);
void ScaleInterveinRowDown38_Any_NEON(const uint8_t* src_ptr,
                                      ptrdiff_t src_stride,
                                      uint8_t* dst_ptr,
                                      int dst_width);
void ScaleInterveinRowDown38_3_Box_Any_NEON(const uint8_t* src_ptr,
                                            ptrdiff_t src_stride,
                                            uint8_t* dst_ptr,
                                            int dst_width);
void ScaleInterveinRowDown38_2_Box_Any_NEON(const uint8_t* src_ptr,
                                   ptrdiff_t src_stride,
                                   uint8_t* dst_ptr,
                                   int dst_width);
...
void ScaleFilterCols_NEON(uint8_t* dst_ptr,
                          ...
                          int x,
                          int dx);
void ScaleFilterInterveinCols_NEON(uint8_t* dst_ptr,
                                   const uint8_t* src_ptr,
                                   int dst_width,
                                   int x,
                                   int dx) ;
...
void ScaleFilterCols_Any_NEON(uint8_t* dst_ptr,
                              ...
                              int x,
                              int dx);
void ScaleFilterInterveinCols_Any_NEON(uint8_t* dst_ptr,
                              const uint8_t* src_ptr,
                              int dst_width,
                              int x,
                              int dx);
