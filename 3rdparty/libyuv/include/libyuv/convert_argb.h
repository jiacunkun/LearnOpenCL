...
LIBYUV_API
int I400ToABGR(const uint8_t* src_y,
               int src_stride_y,
               uint8_t* dst_argb,
               int dst_stride_argb,
               int width,
...
LIBYUV_API
int J400ToABGR(const uint8_t* src_y,
               int src_stride_y,
               uint8_t* dst_argb,
               int dst_stride_argb,
               int width,
...
// Convert JNV12 to ABGR
LIBYUV_API
int JNV12ToABGR(const uint8_t* src_y,
                int src_stride_y,
                const uint8_t* src_vu,
                int src_stride_vu,
                uint8_t* dst_argb,
...
LIBYUV_API
int JNV21ToARGB(const uint8_t* src_y,
               int src_stride_y,
               const uint8_t* src_vu,
               int src_stride_vu,
               uint8_t* dst_argb,
...
// Convert JNV12 to ARGB.
LIBYUV_API
int JNV12ToARGB(const uint8_t* src_y,
	int src_stride_y,
	const uint8_t* src_vu,
	int src_stride_vu,
	uint8_t* dst_argb,
...
// Convert JYUY2 to ARGB
LIBYUV_API
int JYUY2ToARGB(const uint8_t* src_yuy2,
                int src_stride_yuy2,
                uint8_t* dst_argb,
                int dst_stride_argb,
                int width,
...
// Convert JYUY2 to ABGR
LIBYUV_API
int JYUY2ToABGR(const uint8_t* src_yuy2,
                int src_stride_yuy2,
                uint8_t* dst_argb,
                int dst_stride_argb,
                int width,
