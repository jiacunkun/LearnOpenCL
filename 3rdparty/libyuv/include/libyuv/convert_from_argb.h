...
LIBYUV_API
int BGRAToNV12(const uint8_t* src_bgra,
               int src_stride_bgra,
               uint8_t* dst_y,
               int dst_stride_y,
               uint8_t* dst_uv,
...
LIBYUV_API
int ARGBToJNV21(const uint8_t* src_argb,
               int src_stride_argb,
               uint8_t* dst_y,
               int dst_stride_y,
               uint8_t* dst_vu,
...
LIBYUV_API
int ARGBToJNV12(const uint8_t* src_argb,
                int src_stride_argb,
                uint8_t* dst_y,
                int dst_stride_y,
                uint8_t* dst_vu,
...
// Convert ARGB to JYUY2
LIBYUV_API
int ARGBToJYUY2(const uint8_t* src_argb,
                int src_stride_argb,
                uint8_t* dst_yuy2,
                int dst_stride_yuy2,
                int width,
...
// Convert ABGR to JYUY2
LIBYUV_API
int ABGRToJYUY2(const uint8_t* src_argb,
                int src_stride_argb,
                uint8_t* dst_yuy2,
                int dst_stride_yuy2,
                int width,
