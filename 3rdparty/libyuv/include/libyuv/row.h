...
#define HAS_BGRATOYJROW_NEON    //use to caculate BGRAToJ420
#define HAS_BGRATOUVJROW_NEON   //use to caculate BGRAToJ420
...
void NV12ToABGRRow_NEON(const uint8_t* src_y,
                        const uint8_t* src_uv,
                        uint8_t* dst_abgr,
                        const struct YuvConstants* yuvconstants,
                        int width);
...
void NV21ToABGRRow_NEON(const uint8_t* src_y,
                        const uint8_t* src_vu,
                        uint8_t* dst_argb,
                        const struct YuvConstants* yuvconstants,
                        int width);

void JYUY2ToABGRRow_NEON(const uint8_t* src_yuy2,
                        uint8_t* dst_argb,
                        const struct YuvConstants* yuvconstants,
                        int width);
...
void ARGBToY422Row_NEON(const uint8_t* src_argb, uint8_t* dst_y, int width);
void ABGRToYJRow_NEON(const uint8_t* src_abgr, uint8_t* dst_y, int width);
void BGRAToYJRow_NEON(const uint8_t* src_bgra, uint8_t* dst_y, int width);
void ABGRToUV444Row_NEON(const uint8_t* src_abgr,
                         uint8_t* dst_u,
                         uint8_t* dst_v,
                         int width);
void ABGRToUVJ444Row_NEON(const uint8_t* src_abgr,
                         uint8_t* dst_u,
                         uint8_t* dst_v,
                         int width);
...
void ARGBToUVRow_NEON(const uint8_t* src_argb,
                      ...
                      uint8_t* dst_v,
                      int width);
void ARGBToUV422Row_NEON(const uint8_t* src_argb,
                         int src_stride_argb,
                         uint8_t* dst_u,
                         uint8_t* dst_v,
...
void ABGRToUVJRow_NEON(const uint8_t* src_abgr,
                       ...
                       uint8_t* dst_v,
                       int width);
void BGRAToUVJRow_NEON(const uint8_t* src_bgra,
                       int src_stride_bgra,
                       uint8_t* dst_u,
                       uint8_t* dst_v,
                       int width);
...
void ABGRToYJRow_C(const uint8_t* src_abgr, uint8_t* dst_y, int width);
void ABGRToYJRow_Any_NEON(const uint8_t* src_abgr, uint8_t* dst_y, int width);
void BGRAToYJRow_Any_NEON(const uint8_t* src_bgra, uint8_t* dst_y, int width);  //use to caculate BGRAToJ420
...
void BGRAToYJRow_C(const uint8_t* src_bgra, uint8_t* dst_y, int width); 
...
void ARGBToUV444Row_Any_NEON(const uint8_t* src_ptr,
                             ...
                             uint8_t* dst_v,
                             int width);
void ABGRToUV444Row_Any_NEON(const uint8_t* src_abgr,
                             uint8_t* dst_u,
                             uint8_t* dst_v,
                             int width);
void ABGRToUVJ444Row_Any_NEON(const uint8_t* src_abgr,
                             uint8_t* dst_u,
                             uint8_t* dst_v,
                             int width);
void ARGBToUV422Row_Any_NEON(const uint8_t* src_argb,
                             int src_stride_argb,
                             uint8_t* dst_u,
                             uint8_t* dst_v,
                             int width);    //use to caculate I422
...
void ARGBToUVJRow_Any_NEON(const uint8_t* src_ptr,
                           ...
                           uint8_t* dst_v,
                           int width);
void ABGRToUVJRow_Any_NEON(const uint8_t* src_abgr,
                           int src_stride_abgr,
                           uint8_t* dst_u,
                           uint8_t* dst_v,
                           int width);
void BGRAToUVJRow_Any_NEON(const uint8_t* src_bgra,
                           int src_stride_bgra,
                           uint8_t* dst_u,
                           uint8_t* dst_v,
                           int width);    //use to caculate BGRAToJ420
...
void ARGBToUVRow_C(const uint8_t* src_rgb0,
                   ...
                   uint8_t* dst_v,
                   int width);
void ARGBToUV422Row_C(const uint8_t* src_argb,
                      int src_stride_argb,
                      uint8_t* dst_u,
                      uint8_t* dst_v,
                      int width);   //use to caculate I422
void BGRAToUVJRow_C(const uint8_t* src_bgra,
                    int src_stride_bgra,
                    uint8_t* dst_u,
                    uint8_t* dst_v,
                    int width);

void ABGRToUVJRow_C(const uint8_t* src_abgr,
                    int src_stride_abgr,
                    uint8_t* dst_u,
                    uint8_t* dst_v,
                    int width);
...
void ABGRToUV444Row_C(const uint8_t* src_abgr,
                      uint8_t* dst_u,
                      uint8_t* dst_v,
                      int width);
    
void ABGRToUVJ444Row_C(const uint8_t* src_abgr,
                       uint8_t* dst_u,
                       uint8_t* dst_v,
                       int width);
...
void NV12ToARGBRow_C(const uint8_t* src_y,
                     ...
                     const struct YuvConstants* yuvconstants,
                     int width);
void NV12ToABGRRow_C(const uint8_t* src_y,
                     const uint8_t* src_uv,
                     uint8_t* rgb_buf,
                     const struct YuvConstants* yuvconstants,
                     int width);
...
void NV21ToARGBRow_C(const uint8_t* src_y,
                     ...
                     const struct YuvConstants* yuvconstants,
                     int width);
void NV21ToABGRRow_C(const uint8_t* src_y,
                     const uint8_t* src_vu,
                     uint8_t* rgb_buf,
                     const struct YuvConstants* yuvconstants,
                     int width);
void JYUY2ToABGRRow_C(const uint8_t* src_yuy2,
                     uint8_t* dst_argb,
                     const struct YuvConstants* yuvconstants,
                     int width);
...
void I400ToABGRRow_C(const uint8_t* src_y, uint8_t* dst_argb, int width);
...
void NV12ToARGBRow_Any_NEON(const uint8_t* y_buf,
                            ...
                            const struct YuvConstants* yuvconstants,
                            int width);
void NV12ToABGRRow_Any_NEON(const uint8_t* src_y,
                            const uint8_t* src_uv,
                            uint8_t* dst_argb,
                            const struct YuvConstants* yuvconstants,
                            int width);
void NV21ToARGBRow_Any_NEON(const uint8_t* src_y,
                            ...
                            const struct YuvConstants* yuvconstants,
                            int width);
void NV21ToABGRRow_Any_NEON(const uint8_t* src_y,
                            const uint8_t* src_vu,
                            uint8_t* dst_argb,
                            const struct YuvConstants* yuvconstants,
                            int width);
void NV21ToARGBRow_Any_NEON(const uint8_t* y_buf,
                            ...
                            const struct YuvConstants* yuvconstants,
                            int width);
void JYUY2ToABGRRow_Any_NEON(const uint8_t* src_yuy2,
                            uint8_t* dst_argb,
                            const struct YuvConstants* yuvconstants,
                            int width);
